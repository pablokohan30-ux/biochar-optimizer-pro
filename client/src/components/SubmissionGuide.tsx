...
const GUIDES: Guide[] = [
  {
    ...
    steps: [
      ...
      "Subí el PDD al portal en la pestaña \"Project submission\". Adjunta análisis de laboratorio del biochar real (no basta con la simulación).",
  ...
  },
  {
    ...
    steps: [
      "Pedí onboarding al registro de Isometric por email (incluí país, biomasa y capacidad de planta).",
      ...
      "Subí todo al registro. Isometric requiere un panel de revisión por pares antes de emitir créditos; son 2 o 3 científicos independientes que revisan el proyecto.",
